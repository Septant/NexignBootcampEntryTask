...
/**
 * <p>
 * Call Data Record(CDR) - is used to store information about a call
...
public class CDR
{
     ...
     *              <p>
     *              Divides entry to a group of substrings and assigns its values to class fields.
    ...
    /**
     * Converts start time of the call into a long-number.
     * Essential for {@link CDRs} sortByCallStart function.
     * @return 14-digits number
     * */
    ...
    private int[] callDuration(int[] start, int[] end)
    {
        ...
        value[0] =  (int) (duration / 3600L);                               // call-duration array calculations
        duration -= (long) value[0] * 3600;
        value[1] =  (int) (duration / 60);
        duration -= (long) value[1] * 60;
